            ...
            <div key={col.id} className="flex-shrink-0 w-72 max-h-full flex flex-col bg-white/60 dark:bg-white/5 rounded-3xl border border-slate-200 dark:border-white/10 shadow-sm overflow-hidden">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-semibold text-slate-800 dark:text-white text-sm uppercase tracking-widest">{col.name}</h3>
                </div>
                <span className="bg-white dark:bg-white/10 text-slate-600 dark:text-gray-300 text-xs font-medium px-2 py-0.5 rounded-full shadow-sm">
          ...
          <div className="flex justify-between items-start mb-3">
            <div className="flex items-center gap-3 overflow-hidden">
              ...
              <div className="min-w-0 flex flex-col">
                <h4 className="font-semibold text-sm tracking-tight text-slate-800 dark:text-white truncate">{conv.contact_name || conv.contact_phone}</h4>
                <p className="text-[11px] text-slate-500 dark:text-gray-400 font-medium truncate opacity-80">{conv.contact_phone}</p>
              </div>
            </div>
            {conv.unread_count > 0 && (
