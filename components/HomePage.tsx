...
const HomePage: React.FC<HomePageProps> = ({ onNavigate, companyData }) => {
  const { employees, announcements, polls } = companyData;
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          <Announcements announcements={announcements} onNavigate={onNavigate} />
          <RecognitionWall />
        </div>
        {/* Right Sidebar */}
        <div className="space-y-8">
          <QuickLinks onNavigate={onNavigate} />
          <CompanyPoll poll={polls.length > 0 ? polls[0] : null} />
