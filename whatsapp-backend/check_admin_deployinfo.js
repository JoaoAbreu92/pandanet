/**
 * check_admin_deployinfo.js
 * Inspects the full profiles row for admin@deployinfo.com.br.
 */
...
async function run() {
  console.log('=== Profile details for admin@deployinfo.com.br ===');
  const res = await execSQL(`SELECT * FROM public.profiles WHERE email = 'admin@deployinfo.com.br';`);
  try {
