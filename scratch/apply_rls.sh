...
-- Recriar função de exclusão de usuário para limpar dependências de forma robusta e dinâmica
...
-- Recriar função de criação de usuário com todos os parâmetros enviados pelo frontend (22 parâmetros)
...
-- Recriar função de atualização de usuário com todos os parâmetros enviados pelo frontend (27 parâmetros)
...
-- Garantir permissões de execução para todas as novas funções
